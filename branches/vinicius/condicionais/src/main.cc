...
int main() {
    ...
    cout << "4.  Verifica se um numero e par ou impar\n";
    cout << "5.  Realiza potenciacao\n";
    cout << "6.  Verifica triangulo.\n";
    cout << "7.  Verifica qual o signo de uma pessoa.\n";
    ...
    case 1:  // Menor valor entre dois números.";
        ...
        cout << "\nMenor: " << menor(a, b) << ".\n"<< endl;
        break;
    case 2:  //  Maior valor entre dois números.
        cout << "Digite o valor do primeiro numero: ";
        cin >> a;
        cout << "Digite o valor do segundo numero: ";
        cin >> b;
        cout << "\nMaior: " << maior(a, b) << ".\n"<< endl;
        break;
    case 3:  // Maior valor entre três números.
        cout << "Digite o valor do primeiro numero: ";
        cin >> a;
        cout << "Digite o valor do segundo numero: ";
        cin >> b;
        ...
        cout << "\nMaior: " << maior(a, b, c) << ".\n"<< endl;
        break;
    case 4:  // Verifica se um número é par ou impar.
    ...
    case 5:  // Realiza potenciação.
        ...
        break;
    case 6:  // Informa qual o tipo do triângulo.;
        cout << "Digite o valor do primeiro numero: ";
        cin >> x;
        cout << "Digite o valor do segundo numero: ";
        cin >> y;
