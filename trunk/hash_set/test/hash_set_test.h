...
class Teste : public testing::Test {
 protected:
  ...
  void CriaSet(hash_set<int> &c, int n, int v[]) {
    for (int i = 0; i < n; ++i) {
      c.insert(v[i]);
    }
  }
  ...
  string PrintSet(hash_set<int> &c) {
    stringstream out;
    list<int> l;
    if (c.empty()) {
      return "{ }";
...
TEST_F(Teste, Testar_Construtor_por_copia_vazio) {
  ...
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* ~hash_set<Type>::hash_set(hash_set<Type> c) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_Construtor_por_copia_varios_elementos) {
  ...
  CriaSet(c, 5, v);
  hash_set<int> d(c);
  string atual = PrintSet(d);
  string esperado = PrintSet(c);
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* ~hash_set<Type>::hash_set(hash_set<Type> c) *\n"
...
TEST_F(Teste, Testar_metodo_find_em_conjunto_vazio) {
  ...
  ASSERT_FALSE(atual)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* bool hash_set<Type>::find(Type x) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_metodo_insert_em_conjunto_vazio) {
  ...
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* void hash_set<Type>::insert(Type x) *\n"
    << "-------------------------------------------------------------------\n"
    << " Conjunto esperado: " << esperado << "\n"
...
TEST_F(Teste, Testar_metodo_erase_em_conjunto_unitario_com_exito) {
  ...
  ASSERT_TRUE(teste)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* bool hash_set<Type>::erase(Type x) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_metodo_Tolist_em_conjunto_vazio) {
  ...
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* void hash_set<Type>::ToList(list<Type>& l) *\n"
    << "-------------------------------------------------------------------\n"
