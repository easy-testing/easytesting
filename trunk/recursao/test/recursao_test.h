...
TEST(Teste, Testa_MDC_entre_dois_numeros) {
  // Casos analisados:
  // a e b iguais,
...
TEST(Teste, Testa_MDC_entre_tres_numeros) {
  // Casos analisados:
  // a, b e c iguais,
...
TEST(Teste, Testa_sequencia_de_Fibonacci) {
  // Casos analisados:
  // n igual a 0,
  // n igual a 1,
  // valor qualquer.
...
TEST(Teste, Testa_da_Divisao_inteira) {
  // Casos analisados:
  // a menor que b,
  // a igual a b,
...
TEST(Teste, Testa_da_Soma_dos_digitos) {
  // Casos analisados:
  // numero igual a 0,
