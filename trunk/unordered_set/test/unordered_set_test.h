...
class Teste : public testing::Test {
 protected:
  ...
  void CriaSet(unordered_set<int> &c, int n, int v[]) {
    for (int i = 0; i < n; ++i) {
      c.insert(v[i]);
    }
  }
  ...
  string PrintSet(unordered_set<int> &c) {
    stringstream out;
    list<int> l;
    if (c.empty()) {
...
TEST_F(Teste, Testar_Construtor_por_copia_vazio) {
  ...
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:\n"
    << "    *~unordered_set<Type>::unordered_set(unordered_set<Type> c) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_metodo_find_em_conjunto_vazio) {
  ...
  ASSERT_FALSE(atual)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* bool unordered_set<Type>::find(Type x) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_metodo_erase_em_conjunto_unitario_com_exito) {
  ...
  ASSERT_TRUE(teste)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* bool unordered_set<Type>::erase(Type x) *\n"
    << "-------------------------------------------------------------------\n"
...
TEST_F(Teste, Testar_metodo_Tolist_em_conjunto_vazio) {
  ...
  ASSERT_EQ(atual, esperado)
    << "-------------------------------------------------------------------\n"
    << "Erro na funcao:  "
    << "* void unordered_set<Type>::ToList(list<Type>& l) *\n"
    << "-------------------------------------------------------------------\n"
...
#endif  // UNORDERED_SET_TEST_UNORDERED_SET_TEST_H_
