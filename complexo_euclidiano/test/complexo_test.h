...
bool igual(const Complexo& x, const Complexo& y) {
  return fabs(realTest(x) - realTest(y)) <= 1E-6 &&
          fabs(imagTest(x) - imagTest(y)) <= 1E-6;
}
...
TEST_CASE("Testa_funcao_real") {
  ...
  INFO("-------------------------------------------------------------------\n");
  INFO("Erro na funcao: \"double Complexo::realTest()\" \n");
  INFO("-------------------------------------------------------------------\n");
...
TEST_CASE("Testa_funcao_imag") {
  ...
  CHECK_EQ(esperado, atual);
  INFO("-------------------------------------------------------------------\n");
  INFO("Erro na funcao: \"double Complexo::imagTest()\" \n");
  INFO("-------------------------------------------------------------------\n");
  INFO("  Numero Complexo: " << ToString(x) << "\n\n");
