...
struct Node {
  TType key;  // Valor da chave do nó.
...
class Teste : public testing::Test {
 protected:
  Node* NewNode(TType k, Node* l, Node* r, Node* p) {
    Node* aux = new Node();
    aux->key = k;
    aux->left = l;
    aux->right = r;
